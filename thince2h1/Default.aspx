<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="thince2h1._Default" %>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox6Result" runat="server" Enabled="False" Width="120px"></asp:TextBox>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox9A" runat="server" Height="22px">1/13/2013</asp:TextBox>
                <asp:TextBox ID="TextBox9B" runat="server" Height="22px">12/12/2012</asp:TextBox>
                <asp:TextBox ID="TextBox9Result" runat="server" Enabled="False" Height="22px"></asp:TextBox>
            </div>
            <div class="form-group">
